    ...
    <div id="introductionContainer" class="semenDaemonPage" style="width: 800px; text-align: justify">
        ...
        <p>
            <ul>
                ...
                <li><b>Video previews take forever to load</b> - Be aware that during low traffic times the video previews load quickly, but during peak load times it can be slow and they can take like 10 seconds to load.</li>   
            </ul>
        </p>
